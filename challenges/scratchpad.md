...
1. How good are LLMs to be used with pseudo code in prompt to use them as interpreters?
...
2. Is it possible to reach GPT-4 level of performance for narrowed tasks by the use small models? 
